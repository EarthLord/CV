...
\email{p@earthlord.io}                      % optional, remove the line if not wanted
...
\quote{I'm a geek. I cherish contributing and using free and open source technology. I care about sustainability and conservation of the environment. I am proficient with embedded systems and lean iterative development cycle of designing, prototyping and testing.}% \textbf{TODO based on application}}                 % optional, remove the line if not wanted
...
%Section
\section{\textbf{Desired Employment}}
...
\subsection{Hardware}
\cvcomputer{PCB Design}{GeDA, Eagle, OrCAD, KiCad} {Electronics}{Circuit Design \tab{\rightRatingIndent}{\large \textcolor{color1}{•••••}}
...
\cventry{Feb 2015 -- Nov 2015}{Event Officer}{\href{http://alumni.eitictlabs.eu/}{EIT ICT Labs Alumni Board}}{}{}{Primary task of facilitating and supporting creation of events by the Alumni and current students.}
