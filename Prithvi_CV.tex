...
\newcommand{\leftRatingIndent}{45ex}
...
\cvcomputer{Languages}{C, Embedded-C \tab{\leftRatingIndent}{\large \textcolor{color1}{•••••}}
	 \newline Python, bash scripting \tab{\leftRatingIndent}{\large \textcolor{color1}{•••}\textcolor{lightgreen}{••}}
	 \newline HTML, Java, C\# \tab{\leftRatingIndent}{\large \textcolor{color1}{••}\textcolor{lightgreen}{•••}}} 
