...
\address{Bengaluru}{}    % optional, remove the line if not wanted
...
\cventry{Oct 2017 -- present}{Co-founder}{\href{https://appiko.org/}{Appiko}}{Bengaluru}{}{Appiko’s mission is to develop technology that helps the wildlife conservation community. In our quest to create low-cost, low-power, modular hardware and software components  we have started off with SensePi and SenseBe. Both are low-power, app-controlled motion sensors with SensePi detecting body heat and SenseBe detecting a break in a beam of infrared light. As a co-founder I've to keep track of Appiko's big picture  while making sure that the day to day firefighting activities are progressing well. }
...
\cventry{Mar 2017 -- Aug 2017}{Driving Force}{\href{embeddedforher.com}{Embedded for Her program}}{}{}{Embedded for Her is a skill development program in the field of embedded systems for women to increase the gender diversity in this domain. As a volunteer at FSMK, I lead this program full-time. I handled all aspects of the program with assistance from the other volunteers. }
